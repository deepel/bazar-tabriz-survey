...
import { registerPointShopRoutes } from './routes/point-shops';
import { registerServicePointRoutes } from './routes/service-points';
import { registerDoorPointRoutes } from './routes/door-points';
...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  registerPointShopRoutes(app);
  registerServicePointRoutes(app);
  registerDoorPointRoutes(app);
